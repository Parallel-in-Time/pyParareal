...
class TestTimemesh(unittest.TestCase):
  ...
  def test_runcoarseintermediate(self):
    ...
    for i in range(0,self.nslices):
      ...
      assert err<2e-11, ("Successive application of update matrix does not reproduce intermediata coarse values generated by run_coarse. Error: %5.3e in slice %2i" % (err, i))
